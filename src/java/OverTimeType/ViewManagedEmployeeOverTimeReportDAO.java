...
public class ViewManagedEmployeeOverTimeReportDAO {
    ...
    List<OverTimeReport_DTO> listManagedEmployeeOverTimeReport(String searchPersonReportById, String userLoginId) {
    ...
    List<OverTimeReport_DTO> listManagedEmployeeOverTimeReport(String searchOverTimeReportById, Date searchOverTimeReportByDate, String userLoginId) {
        List<OverTimeReport_DTO> listManagedEmployeeOverTimeReport = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
