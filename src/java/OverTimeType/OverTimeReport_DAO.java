 ...
 * @author Hào Cute
 */
public class OverTimeReport_DAO {
    ...
    boolean checkExistDateOfEmployee(Date date, String employeeId) {
    ...
    OverTimeReport_DTO returnReportObject(Date dateOT, float otHours, String reason, String employeeId) {
    ...
    boolean createReport(OverTimeReport_DTO report) {
    ...
    boolean confirmOverTime(Date dateOT, String employeeId, String reasonReject, boolean status) {
    ...
    boolean isEmployeeManagedByUserLogin(String userLogin, String employeeId) {
    ...
    boolean editOverTimeReport(int overTimeId, OverTimeReport_DTO reportAfterEdited) {
