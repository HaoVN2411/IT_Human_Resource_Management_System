...
public class OverTimeController extends HttpServlet {
    ...
    private static final String CREATE_OVERTIME_REPORT = "CreateOTReport";
    ...
    private static final String EDIT_BUTTON_CONTROLLER = "EditButtonController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (VIEW_MANAGED_EMPLOYEE_OVERTIME_REPORT.equals(action)) {
                url = VIEW_MANAGED_EMPLOYEE_OVERTIME_REPORT_CONTROLLER;
            }
            if (VIEW_PERSON_OVERTIME_REPORT.equals(action)) {
                url = VIEW_PERSON_OVERTIME_REPORT_CONTROLLER;
            }
            if (CONFIRM_OVERTIME.equals(action)) {
                url = CONFIRM_OVERTIME_CONTROLLER;
            }
            if (EDIT_BUTTON.equals(action)) {
                url = EDIT_BUTTON_CONTROLLER;
            }
            if (EDIT_OVERTIME.equals(action)) {
