...
public class ViewPersonOverTimeReportDAO {
    ...
    List<OverTimeReport_DTO> listPersonOverTimeReport(Date searchOverTimeReportByDate, String employeeId) {
    ...
    List<OverTimeReport_DTO> listPersonOverTimeReport(String employeeId) {
        List<OverTimeReport_DTO> listPersonOverTimeReport = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
