 ...
 * @author Hào Cute
 */
@WebServlet(name = "EditButtonController", urlPatterns = {"/EditButtonController"})
public class EditButtonController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            OverTimeReport_DTO report = new OverTimeReport_DTO(overTimeId, dateOT, otHours, reason);
            ...
            request.getRequestDispatcher("HRS.jsp").forward(request, response);
        }
    }
